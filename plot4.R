...
# then call the 'Do_Plot4' function. This will save the plot image in the folder where this function exists.

# For example: 

           # Path_to_Data <- "C:/Users/ravi/Desktop/household_power_consumption.txt"
           # Do_Plot4(Path_to_Data)   

Do_Plot4 <- function(Path_to_Data) {
        ...
        plot(DateTime_object,Data_specified_dates$Global_active_power,type="l", xlab='',ylab="Global Active Power")
        ...
        legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1,col=c('black','red','blue'),lwd=2,bty='n')
        plot(DateTime_object,Data_specified_dates$Voltage,type="l", xlab='datetime',ylab="Voltage")
        plot(DateTime_object,Data_specified_dates$Global_reactive_power,type="l", xlab='datetime',ylab="Global_reactive_power")
